...
function add_prayer_time(data) {
  ...
  for (let i of data) {
    prayerContainer.innerHTML += `
            <div class="prayer-default-single">
        ...
        <div class="prayer-times">
            <p class="prayer-link">Asr:</p>
            <p class="prayer-link">${i?.timings.Asr}</p>
        </div>

        <div class="prayer-times">
            <p class="prayer-link">Maghrib:</p>
            <p class="prayer-link">${i?.timings.Maghrib}</p>
        </div>
